...
def search_topics(
    ...
    Returns:
        検索結果のトピック一覧
    """
    return search_topics_impl(project_id, keyword, limit)
...
def search_decisions(
    ...
    Returns:
        検索結果の決定事項一覧
    """
    return search_decisions_impl(project_id, keyword, limit)
